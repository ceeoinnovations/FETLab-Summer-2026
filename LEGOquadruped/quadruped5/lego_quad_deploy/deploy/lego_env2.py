...
class LegoQuadEnv(gym.Env):
  ...
  def _body_frame(self):
    ...
    quat = self.data.qpos[3:7] # the positions of the four motorized joints
    R = np.zeros(9) # 3 x 3 rotation matrix
  ...
  #TODO: Is this the literal stepping motion of the quadruped or is it a step in the training cycle?
