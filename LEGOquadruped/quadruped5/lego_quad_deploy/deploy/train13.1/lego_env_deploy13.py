"""lego_env_deploy13.py
Deployment-matched training environment, v8 (faithful mesh model).

Subclasses lego_env13's LegoQuadEnv (phase-clock trot prior). Adds domain
...
from lego_env13 import LegoQuadEnv, MAX_CRANK_SPEED  # noqa: F401
