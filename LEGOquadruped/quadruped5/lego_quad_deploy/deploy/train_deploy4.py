...
from lego_env_deploy4 import LegoQuadDeployEnv

N_ENVS = 8
TOTAL_STEPS = 3_000_000
MODEL_PATH = Path("lego_quad_deploy_ppo5.zip")


IMU_MODE = "live"     # matches IMU_SOURCE="fused" deployment (verified front-unit semantics)
EPISODE_S = 30.0      # long episodes so heading drift is felt and corrected
