...
Needs policy_weights.npz (from export_policy.py) and numpy_policy.py alongside.
...
USE_LIVE_IMU = True   # True: feed real accelerometer-gravity + gyro.
                      # False: feed zeros (reproduces the frozen-IMU behavior
                      # that walked best). A/B these on hardware.
