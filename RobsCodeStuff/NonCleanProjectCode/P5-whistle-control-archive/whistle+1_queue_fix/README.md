...
For each motor command, the script prompts you to whistle for 2 seconds:

```
[Enter] then whistle for 'forward' (2 s)...
  → Detected 1823 Hz for 'forward'

[Enter] then whistle for 'backward' (2 s)...
  → Detected 743 Hz for 'backward'
...
```
