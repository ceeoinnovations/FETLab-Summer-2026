...
Loads the model trained by train.py, opens the webcam, classifies your
pose every frame, and maps the predicted gesture to motor commands.
"""
...
MODEL_PATH = Path(__file__).parent / "pose_model.pt"

# Map each gesture class name to (left_speed, right_speed)
MOTOR_MAP = {
    "stop":       (   0,    0),
    "forward":    ( 25,  25),
    "backward":   (-25, -25),
...
try:
    while cap.isOpened():
        ...
        cv2.imshow("Pose Drive (PyTorch)", frame)
