...
live between 8 different trained driving approaches by pressing a number
...
print("Loading all 8 models (this only happens once at startup)...")
...
try:
    while cap.isOpened():
        ...
        if mode in (2, 3) and debug_info is not None:
        ...
        cv2.putText(hud, "1-8: switch model   Q: quit", (10, 55),
