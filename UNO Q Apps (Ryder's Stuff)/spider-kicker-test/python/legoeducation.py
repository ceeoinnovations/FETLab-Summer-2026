...
class SingleMotor(_Base):
    ...
    def motor_reset_relative_position(self, position=0):
        _post('/motor/reset_relative_position', handle=self._h, position=position)

    def motor_run_to_relative_position(self, position, speed=None):
        _post('/motor/run_to_relative_position', handle=self._h, position=position, speed=speed)
...
class DoubleMotor(_Base):
    ...
    def motor_reset_relative_position(self, motor=None, position=0):
        _post('/motor/reset_relative_position', handle=self._h, position=position, motor=motor)

    def motor_run_to_relative_position(self, position, motor=None, speed=None):
        _post('/motor/run_to_relative_position', handle=self._h, position=position, motor=motor, speed=speed)
